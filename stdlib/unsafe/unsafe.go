...
func init() {
	Symbols["github.com/GoCodeAlone/yaegi/stdlib/unsafe/unsafe"] = map[string]reflect.Value{
		"Symbols": reflect.ValueOf(Symbols),
	}
	Symbols["github.com/GoCodeAlone/yaegi/yaegi"] = map[string]reflect.Value{
	...
	Symbols["unsafe/unsafe"]["Offsetof"] = reflect.ValueOf(func(any) uintptr { return 0 })
}
...
func sizeof(i any) uintptr {
	return reflect.ValueOf(i).Type().Size()
}

func alignof(i any) uintptr {
