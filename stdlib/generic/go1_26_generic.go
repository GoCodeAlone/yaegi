...
//go:embed go1_26_cmp_cmp.go.txt
var cmpSource string

//go:embed go1_26_maps_maps.go.txt
var mapsSource string

//go:embed go1_26_slices_slices.go.txt
var slicesSource string

/*
//go:embed go1_26_slices_sort.go.txt
var slicesSource1 string

//go:embed go1_26_slices_zsortanyfunc.go.txt
var slicesSource2 string

//go:embed go1_26_sync_oncefunc.go.txt
var syncSource string

//go:embed go1_26_sync_atomic_type.go.txt
